...
const Tester = (props) => {
  const { jsonSchema, fieldType } = props;
  ...
  const generateRandomBoolean = () => {
    const randomValue = generateFakeValue({ fieldType: FIELD_TYPES.BOOLEAN });
    setValue(randomValue);
        ...
        >
            ...
            <Modal
              ...
              onOk={() => {
                ...
                try {
                  ...
                  typecasted = true;
                  try {
                    props.updateValue(typecastedValue);
                    updated = true;
                  } catch (err) {
            ...
            >
              ...
              <div className={styles.types}>
                ...
                >
                  ...
                  <Radio value={FIELD_TYPES.NUMBER}>Number</Radio>
                  <Radio value={FIELD_TYPES.BOOLEAN}>Boolean</Radio>
                  <Radio value={FIELD_TYPES.STRING_LIST}>String list</Radio>
                  <Radio value={FIELD_TYPES.OBJECT}>Object</Radio>
                  <Radio value={FIELD_TYPES.OBJECT_LIST}>Object list</Radio>
                </Radio.Group>
              </div>
            </Modal>
          )}
          ...
          >
            ...
            <div className={styles.generateRandomValues}>
              ...
              <div>
                <Button type="primary" onClick={generateRandomText}>
                  Text
                </Button>
              </div>
              <div>
              ...
              <div>
                <Button type="primary" onClick={generateRandomBoolean}>
                  Boolean
                </Button>
              </div>
              <div>
                <Button type="primary" onClick={generateRandomArrayOfString}>
                  Array of string
                </Button>
              </div>
              <div>
                <Button
                  ...
                  disabled={
                    !jsonSchema || fieldType === FIELD_TYPES.OBJECT_LIST
                  }
                >
                  Object
                </Button>
              ...
              <div>
                <Button
                  ...
                  disabled={!jsonSchema || fieldType === FIELD_TYPES.OBJECT}
                >
                  Array of objects
                </Button>
              </div>
